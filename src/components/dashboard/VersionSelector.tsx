  ...
  return (
    <div className="relative" ref={ref}>
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-[6px] rounded-lg bg-white/5 border border-white/10 text-xs text-white hover:border-white/20 hover:text-white transition-all disabled:opacity-50"
      >
        {switching ? (
